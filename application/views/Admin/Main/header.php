...
<html lang="en">
  <head>
    ...
    <script src="<?php echo base_url();?>includes/js/chart-master/Chart.js"></script>
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header header-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Tolah Toleh</b></a>
            <!--logo end-->
...
=======
                    <li><a class="logout" href="<?php echo base_url('index.php/main/logout'); ?>">Logout</a></li>
